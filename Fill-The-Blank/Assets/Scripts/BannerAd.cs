...
namespace Unity.Services.Mediation.Samples
{
    public class BannerAd : MonoBehaviour
    {
        ...
        public string androidAdUnitId = "4985435";
        ...
        async void Start()
        {
            try
            {
                ...
                Debug.Log("Initialized!"); InitializationComplete();
            }
            catch (Exception e)
            {
        ...
        void InitializationComplete()
        {
            ...
            switch (Application.platform)
            {
                case RuntimePlatform.Android:
                    m_BannerAd =
                    MediationService.Instance.CreateBannerAd(
                    androidAdUnitId, bannerAdSize, bannerAdAnchor);
                    break;
                case RuntimePlatform.IPhonePlayer:
                    m_BannerAd =
                    MediationService.Instance.CreateBannerAd(
                    iosAdUnitId, bannerAdSize, bannerAdAnchor);
                    break;
                ...
                case RuntimePlatform.LinuxEditor:
                    m_BannerAd =
                    MediationService.Instance.CreateBannerAd(
                    !string.IsNullOrEmpty(androidAdUnitId) ?
                    androidAdUnitId : iosAdUnitId, bannerAdSize,
                    bannerAdAnchor);
                    break;
                default:
        ...
        void InitializationFailed(Exception error)
        {
            ...
            {
                initializationError =
                initializeFailedException.initializationError;
            }
